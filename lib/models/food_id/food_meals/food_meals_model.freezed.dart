...
FoodMeals _$FoodMealsFromJson(Map<String, dynamic> json) {
  return _FoodMeals.fromJson(json);
}
...
mixin _$FoodMeals {
  ...
  @JsonKey(ignore: true)
  $FoodMealsCopyWith<FoodMeals> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FoodMealsCopyWith<$Res> {
  factory $FoodMealsCopyWith(FoodMeals value, $Res Function(FoodMeals) then) =
      _$FoodMealsCopyWithImpl<$Res, FoodMeals>;
  @useResult
  $Res call(
      {String idMeal,
      String strMeal,
...
/// @nodoc
class _$FoodMealsCopyWithImpl<$Res, $Val extends FoodMeals>
    implements $FoodMealsCopyWith<$Res> {
  _$FoodMealsCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$FoodMealsImplCopyWith<$Res>
    implements $FoodMealsCopyWith<$Res> {
  factory _$$FoodMealsImplCopyWith(
          _$FoodMealsImpl value, $Res Function(_$FoodMealsImpl) then) =
      __$$FoodMealsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String idMeal,
...
/// @nodoc
class __$$FoodMealsImplCopyWithImpl<$Res>
    extends _$FoodMealsCopyWithImpl<$Res, _$FoodMealsImpl>
    implements _$$FoodMealsImplCopyWith<$Res> {
  __$$FoodMealsImplCopyWithImpl(
      _$FoodMealsImpl _value, $Res Function(_$FoodMealsImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$FoodMealsImpl implements _FoodMeals {
  const _$FoodMealsImpl(
  ...
  factory _$FoodMealsImpl.fromJson(Map<String, dynamic> json) =>
      _$$FoodMealsImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$FoodMealsImplCopyWith<_$FoodMealsImpl> get copyWith =>
      __$$FoodMealsImplCopyWithImpl<_$FoodMealsImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$FoodMealsImplToJson(
      this,
    );
  }
}

abstract class _FoodMeals implements FoodMeals {
  const factory _FoodMeals(
      ...
      final String? strImageSource,
      final String? strCreativeCommonsConfirmed,
      final String? dateModified}) = _$FoodMealsImpl;

  factory _FoodMeals.fromJson(Map<String, dynamic> json) =
      _$FoodMealsImpl.fromJson;
