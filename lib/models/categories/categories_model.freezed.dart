...
/// @nodoc
mixin _$Categories {
  List<Departments> get categories => throw _privateConstructorUsedError;
...
abstract class $CategoriesCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Departments> categories});
}
...
class _$CategoriesImpl implements _Categories {
  const _$CategoriesImpl({required final List<Departments> categories})
      : _categories = categories;

  factory _$CategoriesImpl.fromJson(Map<String, dynamic> json) =>
      _$$CategoriesImplFromJson(json);

  final List<Departments> _categories;
  @override
...
abstract class _Categories implements Categories {
  const factory _Categories({required final List<Departments> categories}) =
      _$CategoriesImpl;
